...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SupercoachTip.score'
        db.add_column('main_supercoach_tip', 'score',
                      self.gf('django.db.models.fields.IntegerField')(null=True, default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SupercoachTip.score'
        db.delete_column('main_supercoach_tip', 'score')
