...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_game', (
            ...
            ('ground', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Ground'], related_name='venue')),
    ...
    models = {
        ...
        'main.game': {
            ...
            'ground': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Ground']", 'related_name': "'venue'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
