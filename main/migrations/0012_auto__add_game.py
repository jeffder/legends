...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_game', (
            ...
            ('legends_away_votes_score', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ...
            ('legends_home_votes_score', self.gf('django.db.models.fields.IntegerField')(default=0)),
