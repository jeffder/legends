...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BrownlowLadder.rank_1'
        db.add_column('main_brownlow_ladder', 'rank_1',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'BrownlowLadder.rank_2'
        db.add_column('main_brownlow_ladder', 'rank_2',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'BrownlowLadder.rank_3'
        db.add_column('main_brownlow_ladder', 'rank_3',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'BrownlowLadder.rank_4'
        db.add_column('main_brownlow_ladder', 'rank_4',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'BrownlowLadder.rank_5'
        db.add_column('main_brownlow_ladder', 'rank_5',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BrownlowLadder.rank_1'
        db.delete_column('main_brownlow_ladder', 'rank_1')

        # Deleting field 'BrownlowLadder.rank_2'
        db.delete_column('main_brownlow_ladder', 'rank_2')

        # Deleting field 'BrownlowLadder.rank_3'
        db.delete_column('main_brownlow_ladder', 'rank_3')

        # Deleting field 'BrownlowLadder.rank_4'
        db.delete_column('main_brownlow_ladder', 'rank_4')

        # Deleting field 'BrownlowLadder.rank_5'
        db.delete_column('main_brownlow_ladder', 'rank_5')
